...
export function generateMetadata({params: {slug}}: WorkParams): Metadata | undefined {
    let post = getPosts(["src", "app", "work", "projects"]).find((post) => post.slug === slug);
    const canonical = `https://${baseURL}/work/${slug}`;
    ...
    return {
        title,
        description,
        // Not recognized in metadata -> TODO: Check how to refactor this
        // images,
        // team,
        openGraph: {
            title,
